...
<nav class="navbar navbar-inverse">
  <div class="container">
    ...
    <ul class="nav navbar-nav navbar-left">
      <li class="active"><a class="caroselbold" href="./BootCarol.jsp">Home</a></li>
...
<div class = "row">
  ...
  <form class= " form-inline form-multiline" role="form"  id="leasingaddsave"  name="leasingadd"     action="LeasingAddSave.jsp"  method = "post">
