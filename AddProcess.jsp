...
<div class = "row">
  ...
  <form class= " form-inline form-multiline" role="form"  id="leasingaddsave"  name="leasingadd"     action="AddReturn.jsp"  method = "post">
...
middlename1        =   request.getParameter("middlename1");
lastname1        ` =   request.getParameter("lastname1");
optgendername1     =   request.getParameter("firstname1");
dobname1           =   request.getParameter("dobname1");
visastatusname1    =   request.getParameter("visastatusname1");
firstname2         =   request.getParameter("firstname2");
middlename2        =   request.getParameter("middlenamemiddlename22");
lastname2          =   request.getParameter("lastname2");
optgendername2     =   request.getParameter("optgendername2");
dob2               =   request.getParameter("dob2");
visastatus2        =   request.getParameter("visastatus2");
...
homezip            =   request.getParameter("homezip");
workphone          =   request.getParameter("workphone");
homephone          =   request.getParameter("homephone");
mobile             =   request.getParameter("mobile");
email              =   request.getParameter("email");

leasingdate        =   request.getParameter("leasingdate");
leasingfrom        =   request.getParameter("leasingfrom");
leasingto          =   request.getParameter("leasingto");
...
routingno          =   request.getParameter("routingno");
accountno          =   request.getParameter("accountno");
bankzip            =   request.getParameter("bankzip");
membersince        =   request.getParameter("membersince");
bankphone          =   request.getParameter("bankphone");
...
try{
	...
	String modinput = "insert into leasingcore_prime(firstname1,middlename1,lastname1,optgendername1,dobname1,visastatusname1,
firstname2,middlename2,lastname2,optgendername2,dob2,visastatus2,
addr1,addr2,city,state,homezip,workphone,homephone,mobile,email,
leasingdate,leasingfrom,leasingto,streetname,buildingno,aptno,
bankname,routingno,accountno,bankzip,membersince,bankphone,
model,make,carno,year,color,license) values ("
+firstname1+"','"+middlename1+"','"+lastname1+"','"+optgendername1+"','"+dobname1        
+visastatusname1+"','"+firstname2+"','"+middlename2+"','"+lastname2       
+optgendername2+"','"+dob2+"','"+visastatus2
+addr1+"','"+addr2+"','"+city+"','"+state+"','"+homezip+"','"+workphone+"','"+homephone+"','"+mobile+"','"+email 
+leasingdate +"','"+leasingfrom+"','"+leasingto+"','"+streetname+"','"+buildingno+"','"+aptno 
+bankname +"','"+routingno+"','"+accountno+"','"+bankzip+"','"+membersince+"','"+bankphone 
+ model +"','" +make +"','"+carno +"','"+year +"','"+color +"','"+license+"'")";


int i = stmt.executeUpdate(modinput);
...
$("#middlename1").val("<%=middlename1%>");
$("#lastname1").val("<%=lastname1%>");
$("#optgendername1").val("<%=optgendername1%>");
$("#dobname1").val("<%=dobname1%>");
$("#visastatusname1").val("<%=visastatusname1%>");
$("#firstname2").val("<%=firstname2%>");
$("#middlename2").val("<%=middlename2%>");
$("#lastname2").val("<%=lastname2%>");
$("#optgendername2").val("<%=optgendername2%>");
$("#dob2").val("<%=dob2%>");
$("#visastatus2").val("<%=visastatus2%>");
...
$("#leasingdate").val("<%=leasingdate%>"); 
$("#leasingfrom").val("<%=leasingfrom%>");
$("#leasingto").val("<%=leasingto%>");
